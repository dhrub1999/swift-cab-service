            ...
            {!loading ? (
              <>
                <Image
                  ...
                  resizeMode="contain"
                />
                <Text className="text-sm mb-4">No recent trips found</Text>
              </>
            ) : (
              <ActivityIndicator size="small" color="#000001" />
            )}
          </View>
        )}
        ListHeaderComponent={() => (
          <>
            ...
            <GoogleTextInput
              ...
              handlePress={handleTripDestinationPress}
            />
